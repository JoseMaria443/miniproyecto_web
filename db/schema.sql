...
CREATE TABLE Calificaciones (
    ...
    puntiacion_media NUMERIC(5,2) GENERATED ALWAYS AS ((parcial1 + parcial2 + final) / 3) STORED
);
...
CREATE INDEX idx_periodo_grupos ON Grupos(periodo);
CREATE INDEX idx_nombre_estudiantes ON Estudiantes(nombre);